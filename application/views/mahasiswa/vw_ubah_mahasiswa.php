            ...
            <div class="card">
                ...
                <form action="" method="POST">
						...
						<div class="form-group mb-2">
							...
							<input type="text" value="<?= $mahasiswa['nim'] ?>" name="nim" id="nim" class="form-control" placeholder="Nim">
						...
						<div class="form-group mb-2">
							...
							<input type="email" value="<?= $mahasiswa['email'] ?>" name="email" id="email" class="form-control" placeholder="Email">
						...
						<div class="form-group mb-2">
							...
							<input type="text" value="<?= $mahasiswa['asal_sekolah'] ?>" name="asal_sekolah" id="asal_sekolah" class="form-control" placeholder="Asal Sekolah">
								<?= form_error('asal_sekolah', '<small class="text-danger pl-3">', '</small>') ?>
						</div>
						<div class="form-group mb-2">
							<label for="no_hp">Nomor Hp</label>
							<input type="text" value="<?= $mahasiswa['no_hp'] ?>" name="no_hp" id="no_hp" class="form-control" placeholder="Nomor Hp">
